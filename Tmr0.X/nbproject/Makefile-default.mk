...
SOURCEFILES_QUOTED_IF_SPACED=Tmr0.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Tmr0.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Tmr0.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Tmr0.o
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Tmr0.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Tmr0.o: Tmr0.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Tmr0.o 
...
${DISTDIR}/Tmr0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/Tmr0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
